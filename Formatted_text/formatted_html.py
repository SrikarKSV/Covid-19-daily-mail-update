...
<html lang="en">
        ...
        <body
                ...
                <div>
                        <h1
                                style="text-align: center;margin-bottom: 3rem;font-weight:bold;text-decoration:underline;color:#4ba04e">
                                Covid-19😷 Updates
                        </h1>
                        <h4><span style="color: #3e474b;">Date:</span> <span
                                        style="color: #3b6978;">{cases_data['date']}</span></h4>
                        ...
                        <div>
                                ...
                                <p><span style="color: #3e474b;">Confirmed cases in last 24
                                                hours:</span> <span
                                                style="color: #3b6978;">{int(cases_data['dailyconfirmed']):,}</span>
                                </p>
                                <p><span style="color: #222831;">Recoveries in last 24 hours:</span><span
                                                style="color: #3b6978;">
                                ...
                                <br>
                                <h4 style="font-size: 22px; color: #494949;">Summary:</h4>
                        ...
                        <br>
                        <p><span style="color: #222831;">For more details visit:</span> <a
                                        href="https://www.covid19india.org/"
                                        target="_blank">https://www.covid19india.org/</a></p>
                        <br>
                        <div>
                                <h2 style="color:#222831;">Country: Global</h2>
                                <p style="margin-bottom: 1.7rem;">Total confirmed cases:</span><span
                                                style="color: #3b6978;">
                                ...
                                <p> <span style="color: #222831;">Total recoveries:</span>
                                        <span
                                                style="color: #3b6978;">{int(cases_data['global_recovered_cases']):,}</span>
                                </p>
                                ...
                                <p> <span style="color: #222831;">Total deaths:</span>
                                        <span style="color: #3b6978;">{int(cases_data['global_death_cases']):,}</span>
                                </p>
                                <p> <span style="color: #222831;">Death rate:</span> <span
